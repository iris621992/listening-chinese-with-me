...
function renderLessonChrome({ lessonSeoHeader, studyPlayer }) {
  return `<div class="lesson-with-sidebar" data-lesson-with-sidebar>${renderLearningSidebar()}<div class="lesson-main-pane"><div class="lesson-shell lesson-content-flow lesson-top-flow">${lessonSeoHeader}${studyPlayer}</div></div></div>`;
}
...
function renderLearningSidebar() {
  ...
  const streakDays = days
    ...
    .join('');
  return `<button type="button" class="lesson-sidebar-mobile-toggle" data-sidebar-open aria-controls="lesson-learning-sidebar" aria-expanded="false" aria-label="Open learning sidebar">☰</button><div class="lesson-sidebar-backdrop" data-sidebar-backdrop hidden></div><aside id="lesson-learning-sidebar" class="lesson-sidebar" data-lesson-sidebar aria-label="Learning tools"><div class="lesson-sidebar-header"><a class="lesson-sidebar-brand" href="${SITE_BASE}/" aria-label="Listening With Me Home"><span class="lesson-sidebar-logo">听</span><span class="lesson-sidebar-text"><strong>Listening With Me</strong></span></a><button type="button" class="lesson-sidebar-toggle" data-sidebar-toggle aria-label="Toggle learning sidebar" data-i18n-aria-label="sidebar_toggle"><span aria-hidden="true">☰</span></button></div><section class="sidebar-section sidebar-streak" aria-label="Weekly streak"><p class="sidebar-section-title" data-i18n="weekly_streak">Weekly streak</p><div class="streak-days" data-streak-days>${streakDays}</div></section><section class="sidebar-section sidebar-language" aria-label="Learning language"><p class="sidebar-section-title" data-i18n="learning_language">Learning language</p><div class="learning-language-list"><span class="learning-language active"><span class="sidebar-icon" aria-hidden="true">中</span><span class="lesson-sidebar-text" data-i18n="chinese">Chinese</span></span><span class="learning-language disabled" aria-disabled="true"><span class="sidebar-icon" aria-hidden="true">VI</span><span class="lesson-sidebar-text" data-i18n="vietnamese_language">Vietnamese</span><span class="soon-badge lesson-sidebar-text" data-i18n="coming_soon">Soon</span></span><span class="learning-language disabled" aria-disabled="true"><span class="sidebar-icon" aria-hidden="true">한</span><span class="lesson-sidebar-text" data-i18n="korean_language">Korean</span><span class="soon-badge lesson-sidebar-text" data-i18n="coming_soon">Soon</span></span><span class="learning-language disabled" aria-disabled="true"><span class="sidebar-icon" aria-hidden="true">日</span><span class="lesson-sidebar-text" data-i18n="japanese_language">Japanese</span><span class="soon-badge lesson-sidebar-text" data-i18n="coming_soon">Soon</span></span></div></section><nav class="sidebar-nav" aria-label="Lesson shortcuts"><a class="sidebar-nav-item" href="${SITE_BASE}/"><span class="sidebar-icon" aria-hidden="true">⌂</span><span class="lesson-sidebar-text" data-i18n="home">Home</span></a><a class="sidebar-nav-item" href="${SITE_BASE}/chinese/#latest-lessons"><span class="sidebar-icon" aria-hidden="true">▶</span><span class="lesson-sidebar-text" data-i18n="video_library">Video Library</span></a><span class="sidebar-nav-item disabled" aria-disabled="true" title="Coming soon"><span class="sidebar-icon" aria-hidden="true">▣</span><span class="lesson-sidebar-text" data-i18n="my_videos">My Videos</span><span class="soon-badge lesson-sidebar-text" data-i18n="coming_soon">Soon</span></span><span class="sidebar-nav-item disabled" aria-disabled="true" title="Coming soon"><span class="sidebar-icon" aria-hidden="true">Aa</span><span class="lesson-sidebar-text" data-i18n="vocabulary">Vocabulary</span><span class="soon-badge lesson-sidebar-text" data-i18n="coming_soon">Soon</span></span><span class="sidebar-nav-item disabled" aria-disabled="true" title="Coming soon"><span class="sidebar-icon" aria-hidden="true">文</span><span class="lesson-sidebar-text" data-i18n="grammar">Grammar</span><span class="soon-badge lesson-sidebar-text" data-i18n="coming_soon">Soon</span></span></nav></aside>`;
}
